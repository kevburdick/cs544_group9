/*
 * This class defines the Sync message
 * client → server requesting STATUS message
...
public class Sync extends Message
{
    ...
    *  Constructor
    */
   public Sync(short pClientID)
   {
      super(Message.SYNC_TYPE,header_size);
